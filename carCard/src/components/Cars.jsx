...
const Cars = ({refreshCars,types}) => {
  ...
  return (
    ...
    <div className="mb-2">
      <input
        type="text"
        placeholder="Ieškoti pagal automobilio numerį..."
        value={search}
        ...
        <table className="w-full border-collapse border border-gray-300 text-xs sm:text-sm">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="border border-gray-300 p-2 whitespace-nowrap min-w-[100px]">Vartotojas</th>
              <th className="border border-gray-300 p-2 whitespace-nowrap min-w-[100px]">Tipas</th>
              ...
              <tr key={car.CAR_ID} className={index % 2 === 0 ? "bg-white" : "bg-gray-50"}>
                ...
                <td className="border border-gray-300 p-2 whitespace-nowrap">
                  <select
                    value={car.CAR_TYPE || ""}
                    onChange={(e) =>
                    handleFieldChange(car.CAR_ID, "CAR_TYPE", e.target.value)
                    }
                    className="w-full border border-gray-200 p-1 rounded"
                  >
                    <option value="">Nepriskirtas</option>
                ...
                <td className="border border-gray-300 p-2 whitespace-nowrap">
                  <input
                    type="text"
                    value={car.CAR_SANDELIS}
                    onChange={(e) =>
                      handleFieldChange(car.CAR_ID, "CAR_SANDELIS", e.target.value)
                    }
                    className="w-full border border-gray-200 p-1 rounded"
                  />
                </td>
                ...
                <td className="border border-gray-300 p-2 whitespace-nowrap">
                  <input
                    type="text"
                    value={car.CAR_TIKSLAS}
                    onChange={(e) =>
                      handleFieldChange(car.CAR_ID, "CAR_TIKSLAS", e.target.value)
                    }
                    className="w-full border border-gray-200 p-1 rounded"
                  />
                </td>
